...
import com.netty.server.utils.DateTimeUtil;
...
public class ChatProto {
    private static final int PING_PROTO = 1 << 8 | 220; //ping消息
    private static final int PONG_PROTO = 2 << 8 | 220; //pong消息
    private static final int SYST_PROTO = 3 << 8 | 220; //系统消息
    private static final int EROR_PROTO = 4 << 8 | 220; //错误消息
    private static final int AUTH_PROTO = 5 << 8 | 220; //认证消息
    private static final int MESS_PROTO = 6 << 8 | 220; //普通消息
